...
public class FirstFormFragment extends Fragment {
    ...
    private String first_order_details = "with";
    ...
    public static FirstFormFragment newInstance(double final_price) {
        FirstFormFragment fragment = new FirstFormFragment();
        Bundle args = new Bundle();
        args.putDouble(PARAM_KEY, final_price);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        next_fragment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (protein_is_selected == true){
                    onButtonPressed(final_price, first_order_details);
                } else if (protein_is_selected == false){
